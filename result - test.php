...
$Bangla2ndwritten=62;
$Bangla2ndObj=23;
$English1st_Number=70;
$English2nd_Number=72;
$Math_Number=60;
$Physics_Number=70; 
$Chemistry_Number=52;
$Biology_Number=70; 
...
// GPA Calculation**********************************
////////////////////////////////////////////////////
if($BiologyPoint=="Error"){
    $Biology_optional="Error";
}elseif($BiologyPoint>2){
...
if($BanglaPoint=="Error"||$EnglishPoint=="Error"||$MathPoint=="Error"||$PhysicsPoint=="Error"||$ChemistryPoint=="Error"||$Biology_optional=="Error"){
    $Total_point= "Your final GPA is Error!";
}else{
    $final_Gpa="Your final GPA is " . $Total_point=($BanglaPoint+$EnglishPoint+$MathPoint+$PhysicsPoint+$ChemistryPoint+$Biology_optional)/5;
};

if($Total_point=="Your final GPA is Error!"){
    $final_Gpa="Your final GPA is Error!";
}elseif($Total_point>5){
    $final_Gpa="GPA is 5"; 
}else{
    "Your final GPA is $final_Gpa";
};

echo "\n";


if($final_Gpa=="Your final GPA is Error!"){
    $finalGrade="Error!";
}elseif($BanglaPoint==0||$EnglishPoint==0||$MathPoint==0||$PhysicsPoint==0||$ChemistryPoint==0){
    $finalGrade="F";
}elseif($BanglaPoint==5 && $EnglishPoint==5 && $MathPoint==5 && $PhysicsPoint==5 && $ChemistryPoint==5 && $BiologyPoint==5){
    $finalGrade="Golden A+";
}elseif($BanglaPoint==5 && $EnglishPoint==5 && $MathPoint==5 && $PhysicsPoint==5 && $ChemistryPoint==5 && $BiologyPoint!=5){
    $finalGrade="A+";
}elseif($final_Gpa==5 || $final_Gpa>5){
    $finalGrade="A+";
}elseif($final_Gpa==4 || $final_Gpa<=4.99){
    $finalGrade="A";
}elseif($final_Gpa==3.5 || $final_Gpa<=3.99 ){
    $finalGrade="A-";
}elseif($final_Gpa==3 || $final_Gpa<=3.49){
    $finalGrade="B";
}elseif($final_Gpa==2 || $final_Gpa<=2.99){
    $finalGrade="C";
}elseif($final_Gpa==1 || $final_Gpa<=1.99){
    $finalGrade="D";
};   

echo "Your final Grade is $finalGrade & $final_Gpa";
