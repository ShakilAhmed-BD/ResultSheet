...
if($BanglaPoint=="Error"||$EnglishPoint=="Error"||$MathPoint=="Error"||$PhysicsPoint=="Error"||$ChemistryPoint=="Error"||$Biology_optional=="Error"){
    echo $Total_point="Your final GPA is Error!";
}else{
$Total_point=($BanglaPoint+$EnglishPoint+$MathPoint+$PhysicsPoint+$ChemistryPoint+$Biology_optional)/5;
};
...
echo "\n"; 
// if($Total_point>5 || $Biology_optional==5){
//     echo $Total_point="Golden A+";
// }elseif($Total_point>5){
//     echo $Total_point=5;
// };

// echo"\n";
// echo "Your Final GPA is $Total_point";
// echo"\n";
/////////////////////////////////////////////////////////////////////////////////////
...
if($BanglaPoint==0||$EnglishPoint==0||$MathPoint==0||$PhysicsPoint==0||$ChemistryPoint==0){
    ...
    $finalGrade="A+";
}elseif($Total_point>=4 && $Total_point<=4.99){
    $finalGrade="A";
}elseif($Total_point>=3.5 && $Total_point<=3.99 ){
    $finalGrade="A-";
}elseif($Total_point>=3 && $Total_point<=3.49){
    $finalGrade="B";
}elseif($Total_point=2 && $Total_point<=2.99){
    $finalGrade="C";
}elseif($Total_point=1 && $Total_point<=1.99){
    $finalGrade="D";
};
